...
class value
{
  ...
  public:
    ...
    value(null_type    v): value_(std::move(v)) {}
    ...
    value& operator=(null_type    v) { value_ = std::move(v); return *this;}
    ...
    bool is_null   () const noexcept {return value_.index() ==  0;}
    ...
    bool is_bin    () const noexcept {return value_.index() ==  6;}
    bool is_str    () const noexcept {return value_.index() ==  7;}
    ...
    null_type   & as_null   () {return std::get< 0>(value_);}
    ...
    bin_type    & as_bin    () {return std::get< 6>(value_);}
    str_type    & as_str    () {return std::get< 7>(value_);}
    ...
    null_type    const& as_null   () const {return std::get< 0>(value_);}
    ...
    bin_type     const& as_bin    () const {return std::get< 6>(value_);}
    str_type     const& as_str    () const {return std::get< 7>(value_);}
    ...
    null_type   * try_null   () {return std::get_if< 0>(std::addressof(value_));}
    ...
    bin_type    * try_bin    () {return std::get_if< 6>(std::addressof(value_));}
    str_type    * try_str    () {return std::get_if< 7>(std::addressof(value_));}
    ...
    null_type    const* try_null   () const {return std::get_if< 0>(std::addressof(value_));}
    ...
    bin_type     const* try_bin    () const {return std::get_if< 6>(std::addressof(value_));}
    str_type     const* try_str    () const {return std::get_if< 7>(std::addressof(value_));}
...
using null_type    = value::null_type   ;
